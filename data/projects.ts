...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screens: [
      {
        src: "/projects/project-02/01-ai-profit-loss.png",
        label: "Finance",
        title: "AI Profit & Loss",
        description: "Margins, costs, and profit trends — explained by AI.",
      },
      {
        src: "/projects/project-02/02-ai-sales-performance.png",
        label: "Sales",
        title: "AI Sales Performance",
        description: "What's selling and why, broken down by AI.",
      },
      {
        src: "/projects/project-02/03-ai-smart-procurement.png",
        label: "Procurement",
        title: "AI Smart Procurement",
        description: "AI-driven restock and buying recommendations.",
      },
    ],
  },
  {
